...
var random_names = ["ksiisdaddy69420", "IAMINYOURWALLS", "ILikeMyCheeseDrippyBruh", "chatisthisrizz103",
"juarez", "Quinterious_Harris_183", "McGoopster4239", "yuuurrr", "eggsnorter999", "PHDInYappanomics554",
"BootyBrigadierX", "SirLemonZesty", "dookie_lord_3980", "PickleJuicePapa", "bigtoesandwich", "JuicyPastaLover69", "SPEEDYTORTILLA", "toeToucher3000", "CouchPotatoXL", "smellysock123", "DEMONOFJELLY", "xXstankygamerXx", "NEONWORMMAN",
"twinkiedestroyer", "BigBoiCheddar", "rizzplug", "CHUNKYSAUCEKING", "quackinator42", "noobslayer900", "chickennuggetz", "BackwardsBiscuit", "sneakysausage88", "BigToothBilly",
"shadygrape69", "TacoWhisperer", "MIGHTYMUFFINZ", "eggplanthead666", "BLASTMASTERBEANS", "goober_juice", "fizzpopper300", "CaptainCringeLord", "sausagewizard", "SIR_SOGGYPANTS",
"soggypoptart", "iAmUrFbiAgent", "2Shady4YouBro", "ToeCrusader420", "lactoseintolerantmayo", "sir_screamsalot", "GUTSFORGRAVY", "CheeseDemolisher69", "mom_come_pick_me_up", "xXLoudMouthLizardXx",
"silent_fart_sorcery", "BURNTCHICKENNUG", "krispy_rancher", "plsbemygirlfriend123", "crustykneecaps", "CertifiedDumpsterFire", "mushroombrainzz", "urmomsbf",
"horndog91", "Creamius", "ArmpitCheese2395","NuggetMonster192349", "ShaquilleOatmeal", "soggysaladfanatic", "wheezy_peas", "icriedoverbread", "cereal_milk_supremacist",
